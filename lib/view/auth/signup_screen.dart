      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _buildTrustChip(Icons.mail_outline_rounded, 'Email verified'),
              const SizedBox(width: 8),
              _buildTrustChip(Icons.shield_outlined, 'Safer community'),
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(icon, color: const Color(0xFF6D8BBD), size: 20),
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(Icons.lock_outline_rounded,
              color: const Color(0xFF6D8BBD), size: 20),
